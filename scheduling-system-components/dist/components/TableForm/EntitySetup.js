...
function EntitySetup(_a) {
    ...
    var _e = (0, useEntitySetup_1.useEntitySetup)({
        ...
        showToast: showToast
    }), errors = _e.errors, setErrors = _e.setErrors, handleEntitySelect = _e.handleEntitySelect, handleEntityNameChange = _e.handleEntityNameChange, handleAttributeNameChange = _e.handleAttributeNameChange, handleDefaultValueChange = _e.handleDefaultValueChange, handleConstraintsChange = _e.handleConstraintsChange, handleValidationsChange = _e.handleValidationsChange, originalHandleAddAttribute = _e.handleAddAttribute;
    ...
    var _f = (0, react_1.useState)(''), selectedInputType = _f[0], setSelectedInputType = _f[1];
    // Update state type
    var _g = (0, react_1.useState)([]), inputOptions = _g[0], setInputOptions = _g[1];
    var _h = (0, react_1.useState)(''), newOption = _h[0], setNewOption = _h[1];
    // Add validation errors state
    var _j = (0, react_1.useState)({}), validationErrors = _j[0], setValidationErrors = _j[1];
    // First, add a new state for select type
    var _k = (0, react_1.useState)(false), isMultiSelect = _k[0], setIsMultiSelect = _k[1];
    ...
    var handleInputTypeChange = function (e) {
        ...
        if (['select', 'radio', 'checkbox'].includes(inputType)) {
            ...
            var _a = configData.inputTypes[inputType], dataType = _a.dataType, size = _a.size, precision = _a.precision, _b = _a.options, options = _b === void 0 ? [] : _b, isDataTypeFixed = _a.isDataTypeFixed;
            ...
            setCurrentAttribute(__assign(__assign({}, currentAttribute), { inputType: inputType, dataType: isDataTypeFixed ? dataType : currentAttribute.dataType, size: size || null, precision: precision || null, options: formattedOptions, validations: {}, isMultiSelect: inputType === 'select' ? false : undefined }));
        }
    };
