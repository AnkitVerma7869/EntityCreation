...
function EntitySetup(props) {
    var _this = this;
    var _a;
    var configData = props.configData, entityName = props.entityName, setEntityName = props.setEntityName, attributes = props.attributes, setAttributes = props.setAttributes, currentAttribute = props.currentAttribute, setCurrentAttribute = props.setCurrentAttribute, isCustomEntity = props.isCustomEntity, setIsCustomEntity = props.setIsCustomEntity, selectedEntity = props.selectedEntity, setSelectedEntity = props.setSelectedEntity, editingIndex = props.editingIndex, setEditingIndex = props.setEditingIndex, handleSaveEntity = props.handleSaveEntity, resetForm = props.resetForm;
    ...
    }), errors = _b.errors, setErrors = _b.setErrors, handleEntitySelect = _b.handleEntitySelect, handleEntityNameChange = _b.handleEntityNameChange, handleAttributeNameChange = _b.handleAttributeNameChange, handleDefaultValueChange = _b.handleDefaultValueChange, handleConstraintsChange = _b.handleConstraintsChange, handleValidationsChange = _b.handleValidationsChange, handleAddAttribute = _b.handleAddAttribute;
