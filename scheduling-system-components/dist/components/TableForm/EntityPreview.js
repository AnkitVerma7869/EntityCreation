...
function EntityPreview(_a) {
    var _this = this;
    var attributes = _a.attributes, setAttributes = _a.setAttributes, setCurrentAttribute = _a.setCurrentAttribute, handleSaveEntity = _a.handleSaveEntity, resetForm = _a.resetForm, setEditingIndex = _a.setEditingIndex, entityName = _a.entityName, showToast = _a.showToast;
